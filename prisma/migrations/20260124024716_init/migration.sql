...
-- CreateTable
CREATE TABLE "_CommentToExperienceExchange" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_CommentToExperienceExchange_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE INDEX "_CommentToExperienceExchange_B_index" ON "_CommentToExperienceExchange"("B");
...
-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_helpPostId_fkey" FOREIGN KEY ("helpPostId") REFERENCES "HelpAnimal"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_adoptPostId_fkey" FOREIGN KEY ("adoptPostId") REFERENCES "AdoptAnimal"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Reaction" ADD CONSTRAINT "Reaction_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Reaction" ADD CONSTRAINT "Reaction_helpPostId_fkey" FOREIGN KEY ("helpPostId") REFERENCES "HelpAnimal"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Reaction" ADD CONSTRAINT "Reaction_experienceId_fkey" FOREIGN KEY ("experienceId") REFERENCES "ExperienceExchange"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "AdoptionForm" ADD CONSTRAINT "AdoptionForm_petId_fkey" FOREIGN KEY ("petId") REFERENCES "AdoptAnimal"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_CommentToExperienceExchange" ADD CONSTRAINT "_CommentToExperienceExchange_A_fkey" FOREIGN KEY ("A") REFERENCES "Comment"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_CommentToExperienceExchange" ADD CONSTRAINT "_CommentToExperienceExchange_B_fkey" FOREIGN KEY ("B") REFERENCES "ExperienceExchange"("id") ON DELETE CASCADE ON UPDATE CASCADE;
